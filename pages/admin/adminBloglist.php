...
<?php while($blog->fetch()) : ?>
          <div class="bg-white center rounded overflow-hidden">
            <div class="p-1">
              ...
              <button class='px-4 py-2 text-sm rounded-sm font-bold text-white border-2 border-white bg-[#00FF00] transition-all ease-in-out duration-300 hover:bg-white hover:text-[#00FF00] hover:border-[#00FF00]'><a href="error.php" >Edit</a></button>
