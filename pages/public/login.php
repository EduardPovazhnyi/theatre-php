...
<div class="bg-gray-50 font-[sans-serif]">
      <div class="min-h-screen flex flex-col items-center justify-center py-6 px-4">
        <div class="max-w-md w-full">
          ...
          src="<?= ROOT_DIR ?>assets/images/clyde_theatre_tp.png" alt="logo" class='w-40 mb-8 mx-auto block' />
          </a>

          <div class="p-8 rounded-2xl bg-white shadow">
            <h2 class="text-gray-800 text-center text-2xl font-bold">Sign in</h2>
            <form class="mt-8 space-y-4" action="loginController" method="post">
            ...
            <?php endif?>
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  <input name="password" type="password" required class="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600"  />
              ...
              <p class="text-gray-800 text-sm !mt-8 text-center">Don't have an account? <a href="register" class="text-[#880707] hover:text-[#4D0000] ml-1 whitespace-nowrap font-semibold">Register here</a></p>
            </form>
          </div>
        </div>
      </div>
