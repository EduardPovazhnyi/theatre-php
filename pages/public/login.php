        ...
        <div class="max-w-md w-full">
          ...
          <div class="p-8 rounded-2xl bg-white shadow">
            ...
            <?php endif?>
              ...
              <p class="text-gray-800 text-sm !mt-8 text-center">Don't have an account? <a href="register" class="text-[#880707] hover:text-[#4D0000] ml-1 whitespace-nowrap font-semibold hover:underline">Register here</a></p>
            </form>
          </div>
        </div>
      </div>
