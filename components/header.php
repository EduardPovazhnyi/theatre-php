...
<head>
    ...
    <header class='flex shadow-lg py-4 px-4 sm:px-10 bg-[#880707] font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
      <div class='flex flex-wrap items-center justify-between gap-4 w-full'>
        
      <a href="home"
          class=" w-[70px]"><img
            src="<?= ROOT_DIR ?>assets/images/clyde_theatre_tp.png" alt="logo" class='w-[70px]' />
        </a>

        <div id="collapseMenu"
          class='max-lg:hidden max-lg:w-full max-lg:fixed max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50 flex items-center'>
          ...
          <ul
            class='lg:flex lg:gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-[#880707] max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
            <li class='mb-6 hidden max-lg:block'>
              <a href="home"><img src="<?= ROOT_DIR ?>assets/images/clyde_theatre_tp.png" alt="logo" class='w-36' />
              </a>
            </li>
